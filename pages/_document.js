  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Niral Dharmnathi Niral Dharmnathi - Project Manager and Google PM Certified with 8+ years of IT experience in Agile, AI-driven projects, and digital transformation. Based in Ahmedabad, India."
        />

        <meta
          name="keywords"
          content="Niral Dharmnathi Niral Dharmnathi, Project Manager Ahmedabad, Agile Project Manager India, AI Project Management, Technical Project Manager, IT Project Coordinator, Google PM Certified, Scrum Master, Digital Transformation Expert, Stakeholder Management, Cross-functional Team Leadership"
        />
        ...
        <meta name="twitter:title" content="Niral Dharmnathi Niral Dharmnathi | Project Manager Portfolio" />
        <meta
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Person",
              name: "Niral Dharmnathi Niral Dharmnathi",
